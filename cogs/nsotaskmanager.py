...
class NSOTaskManager(commands.Cog):
    ...
    async def nso_taskmanager(interaction: discord.Interaction, followers: app_commands.Range[int, 0, 100], stress: app_commands.Range[int, 0, 100], affection: app_commands.Range[int, 0, 100], md: app_commands.Range[int, 0, 100]):
